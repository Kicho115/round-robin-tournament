...
#
apr_builddir=$(INCLUDE)/../build-1
apr_builders=$(INCLUDE)/../build-1
top_builddir=$(INCLUDE)/../build-1
...
#
CFLAGS=-Wno-error=implicit-function-declaration -fPIC -O3
CPPFLAGS=-DNDEBUG
LDFLAGS=-L$(INCLUDE)/../lib
LIBS=
DEFS=-DHAVE_CONFIG_H
