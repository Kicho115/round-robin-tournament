...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/home/Rafael/tournaments/cmake-build-debug-wsl/vcpkg_installed/x64-linux' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/Rafael/tournaments/cmake-build-debug-wsl/vcpkg_installed/x64-linux/lib -L/home/Rafael/tournaments/cmake-build-debug-wsl/vcpkg_installed/x64-linux/lib/manual-link' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/Rafael/vcpkg/packages/libpq_x64-linux/lib/pkgconfig:/home/Rafael/vcpkg/packages/libpq_x64-linux/share/pkgconfig:/home/Rafael/tournaments/cmake-build-debug-wsl/vcpkg_installed/x64-linux/lib/pkgconfig:/home/Rafael/tournaments/cmake-build-debug-wsl/vcpkg_installed/x64-linux/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.9 on x86_64-pc-linux-gnu, compiled by cc (GCC) 15.2.1 20250808 (Red Hat 15.2.1-1), 64-bit"
